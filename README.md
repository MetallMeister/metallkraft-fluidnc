...
**[最新ベータ版 v0.1.13をダウンロード（ZIP）](https://github.com/MetallMeister/metallkraft-fluidnc/releases/download/v0.1.13/metallkraft-ui-v0.1.13.zip)** · [旧ベータ版 v0.1.12](https://github.com/MetallMeister/metallkraft-fluidnc/releases/download/v0.1.12/metallkraft-ui-v0.1.12.zip) · **[過去のバージョン一覧](docs/VERSIONS.md)**
